static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NEW_TWINROOT_TOWN - 1] = {MAP_GROUP(NEW_TWINROOT_TOWN), MAP_NUM(NEW_TWINROOT_TOWN), 10, 10},
    [HEAL_LOCATION_ROUTE301 - 1] = {MAP_GROUP(ROUTE301), MAP_NUM(ROUTE301), 10, 12},
};
